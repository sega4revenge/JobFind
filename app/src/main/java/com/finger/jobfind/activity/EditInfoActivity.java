...
import com.finger.jobfind.fragment.DatePickerFragment;
...
//        locationpref = user.get(SessionManager.KEY_LOCATION);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (edName == "" || edEmail == "" || edAge == "" || edPhone == "" || edLocation == "") {
    ...
    public void showDialog() {
        ...
        //list of items
        final String[] items = getResources().getStringArray(R.array.diadiem);
